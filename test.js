...
t('real use-case', t => {
	...
	var result = c`.bootstrap .clearfix{*zoom:1;}.bootstrap .clearfix:before,.bootstrap .clearfix:after{display:table;content:\"\";line-height:0;}
	...
	.bootstrap input,.bootstrap textarea,.bootstrap .uneditable-input{width`;

	t.equal(scope(src, '.bootstrap'), result);
	t.end()
})
